  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden">
        <div ref={emblaRef} className="overflow-hidden">
          <div className="flex">
            {slides.map((slide, index) => (
              ...
              >
                <div className="relative min-h-[70svh] w-full sm:min-h-[75svh] lg:min-h-[85svh]">
                  <Image
                    src={slide.src}
        ...
        <div className="pointer-events-none absolute inset-0 z-[5] flex items-center justify-center px-6 sm:px-10">
